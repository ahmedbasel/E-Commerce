...
export const routes: Routes = [
    ...
    {path:'brands',component:BradnsComponent,title:'Bradns',canActivate:[authGuard]},
    ...
    {path:'single/:pid',component:SingleProductComponent,title:'single',canActivate:[authGuard]},
